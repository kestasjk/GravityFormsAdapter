...
CREATE TABLE [dbo].[tblGravityFormLogs](
	[id] [int] IDENTITY(1,1) NOT NULL,
	[startTime] [datetime] NOT NULL,
	[endTime] [datetime] NULL,
	[isSuccess] [int] NOT NULL,
	[errorMessage] [nvarchar](max) NULL,
	[newFormCount] [int] NOT NULL,
 CONSTRAINT [PK_tblGravityFormLogs] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
...
ALTER TABLE [dbo].[tblGravityFormLogs] ADD  CONSTRAINT [DF_tblGravityFormLogs_startTime]  DEFAULT (getdate()) FOR [startTime]
GO
ALTER TABLE [dbo].[tblGravityFormLogs] ADD  CONSTRAINT [DF_tblGravityFormLogs_isSuccess]  DEFAULT ((0)) FOR [isSuccess]
GO
ALTER TABLE [dbo].[tblGravityFormLogs] ADD  CONSTRAINT [DF_tblGravityFormLogs_newFormCount]  DEFAULT ((0)) FOR [newFormCount]
GO
